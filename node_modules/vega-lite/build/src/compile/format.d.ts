...
export declare function guideFormat(fieldOrDatumDef: FieldDef<string> | DatumDef<string>, type: Type, format: string | object, formatType: string, config: Config, omitTimeFormatConfig: boolean): string | {
    signal: string;
};
